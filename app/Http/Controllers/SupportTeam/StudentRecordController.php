   ...
   public function __construct(LocationRepo $loc, MyClassRepo $my_class, UserRepo $user, StudentRepo $student)
   {
    ...
    public function store(StudentRecordCreate $req)
    {
       ...
       /* $ct = ($ct == 'J') ? 'JSS' : $ct;
        ...
        $data['branch_id'] = Auth::user()->branch_id; // Add branch_id
        ...
        $sr['branch_id'] = Auth::user()->branch_id; // Add branch_id
    ...
    {
        $data['my_class'] = $mc = $this->my_class->getMC(['id' => $class_id, 'branch_id' => Auth::user()->branch_id])->first();
        $data['students'] = $this->student->findStudentsByClass($class_id, Auth::user()->branch_id);
    ...
    {
        $data['my_classes'] = $this->my_class->all();
        $data['students'] = $this->student->allGradStudents(Auth::user()->branch_id);
    ...
    public function show($sr_id)
    {
        ...
        $data['sr'] = $this->student->getRecord(['id' => $sr_id, 'branch_id' => Auth::user()->branch_id])->first();
    ...
    public function update(StudentRecordUpdate $req, $sr_id)
    {
        ...
        $sr = $this->student->getRecord(['id' => $sr_id, 'branch_id' => Auth::user()->branch_id])->first();
    ...
    public function destroy($st_id)
    {
        ...
        $sr = $this->student->getRecord(['user_id' => $st_id, 'branch_id' => Auth::user()->branch_id])->first();
